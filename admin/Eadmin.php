...
<div class="pagetitle">
      ...
      <?php
          ...
          $sqldataadmin="SELECT * FROM tbl_admin WHERE id='$idadmin'";
          //ambil koneksi data
     ...
     <h5 style="color:darkblue; font-weight:bold; margin-top:13px; margin-bottom:40px">Edit Admin( <?= $data['fulname']; ?> - <?= $data['username']; ?> )</h5><br><br>
    ...
    <div class="row mb-3">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="idadmin" id="idadmin" value="<?=$data['id']?>" placeholder="" class="form-control" style="font-size:13px;">
                  </div>
          </div>
      ...
      <div class="row mb-3">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="nmadmin" id="nmadmin" value="<?=$data['fulname']?>" placeholder="" class="form-control" style="font-size:13px;">
                  </div>
          </div>
      ...
      <div class="row mb-3">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="user" id="user" value="<?=$data['username']?>" placeholder="" class="form-control" style="font-size:13px;">
                  </div>
      </div>
      ...
      <div class="row mb-3">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="pass" id="pass" value="<?=$data['pass']?>" placeholder="" class="form-control" style="font-size:13px;">
                  </div>
          </div><br>
