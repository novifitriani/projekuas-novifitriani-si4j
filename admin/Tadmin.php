...
<div class="pagetitle">
    ...
    <h5 style="color:darkblue; font-weight:bold; margin-top:13px; margin-bottom:40px">Tambah Data Admin </h5><br><br><br>
      ...
      <div class="row mb-3">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="idadmin" id="idadmin" placeholder="tidak perlu diisi, karena terisi otomatis!!" class="form-control" style="font-size:13px;">
                  </div>
          </div>
          ...
          <div class="row mb-3">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="nmadmin" id="nmadmin" placeholder="masukan nama lengkap admin" class="form-control" style="font-size:13px;">
                  </div>
          </div>
          ...
          <div class="row mb-3">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="user" id="user" placeholder="masukan nama pengguna admin" class="form-control" style="font-size: 13px;">
                  </div>
          </div>
